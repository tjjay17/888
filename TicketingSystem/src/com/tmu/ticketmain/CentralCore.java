...
public static void readUsers() throws FileNotFoundException, IOException{
    ...
    while (currentLine.equals("END") != null) {
        ...
        if(userType.equals("AA")){
            userList.add(new Admin("Admin", userName, credit));
        }else if(userType.equals("FS")){
            userList.add(new Standard_Full("Standard_Full", userName, credit));
        }else if(userType.equals("BS")){
            userList.add(new Standard_Buy("Standard_Buy", userName, credit));
        }else if(userType.equals("SS")){
            userList.add(new Standard_Sell("Standard_Sell", userName, credit));
        }
